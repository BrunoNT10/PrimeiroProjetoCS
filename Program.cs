...
namespace meuPrimeiroProjeto
{
    ...
    {    
        static void Main(string[] args)
        {
            ...
            bool retorno_funcao_depositar = contaDaBarbara.Depositar(200);
            bool retorno_funcao_depositar1 = contaDoBruno.Depositar(200);
            bool retorno_funcao_depositar2 = contaDaGabriel.Depositar(200);
